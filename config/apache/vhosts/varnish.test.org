<VirtualHost *:8080>
  ...
  ServerName varnish.test.org:8080

  DocumentRoot /srv/varnish/drupal6

  <Directory /srv/varnish/drupal6>
  ...
  <Directory /srv/varnish/drupal6/sites/default/files/private>
    Deny from all
  </Directory>      
